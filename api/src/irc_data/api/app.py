...
from irc_data.api.routers import adjudication, admin, admin_customers, admin_dupes, admin_overview, admin_tables, analytics, audit, boats, checkout, corrections, data_health, designs, events, fleet, health, insights, pipeline, quality_gates, reconciliation, reports, run_ledger, scrapers, search, sources, stats, surveys, swarm, users, what_if  # noqa: E402
...
app.include_router(admin_customers.router, prefix="/v1", tags=["Admin"])
...
app.include_router(admin_dupes.router, prefix="/v1", tags=["Admin"])
...
app.include_router(audit.router, prefix="/v1", tags=["Admin"])
