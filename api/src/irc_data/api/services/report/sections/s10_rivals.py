...
from irc_data.api.services.report.facts_builders import build_rivals
from irc_data.api.services.report.prompts import RIVALS_PROMPT, SYSTEM_PROMPT_V2
